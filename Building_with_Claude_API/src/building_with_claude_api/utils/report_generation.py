"""
Generated HTML report for prompt evaluation results.
This module provides a function to generate an HTML report from the evaluation results of prompt tests.
The report includes summary statistics and detailed results for each test case, including the scenario, prompt inputs
"""
