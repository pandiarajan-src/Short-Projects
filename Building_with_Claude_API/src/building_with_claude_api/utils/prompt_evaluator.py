"""
PromptEvaluator is a utility class designed to facilitate the evaluation of AI-generated outputs against specified test cases. 
It provides methods to generate unique test case ideas, create detailed test cases, run evaluations, and grade outputs based on defined criteria. The class supports concurrent execution of tasks to improve efficiency when generating and evaluating multiple test cases.
...
from .report_generation import generate_prompt_evaluation_report
from .llm_messages import add_user_message, add_assistant_message, chat
