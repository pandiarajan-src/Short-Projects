...
if __name__ == "__main__":
    messages = []
    image_path = Path(__file__).resolve().parent / "images/prop3.png"
    add_image_to_user_message(messages, image_path, prompt)
    response = chat(messages, model="claude-sonnet-4-5")
    print(response)
